...
let toggleSwitchBackgroundTexture = new Texture("switchBackground.png");
let toggleSwitchForegroundTexture = new Texture("switchForeground.png");
...
let MainScreen = Container.template($ => ({
	...
	contents: [
		...
		Container($, {
			top:200, right:30, height:0, skin:footerSkin,
			contents: [
				Port($, {
					width:toggleSwitchForegroundTexture.width, height:toggleSwitchForegroundTexture.height, active:true,
					Behavior: class extends ToggleSwitchBehavior {
